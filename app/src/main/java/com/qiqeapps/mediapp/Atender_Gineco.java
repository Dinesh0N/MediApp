...
public class Atender_Gineco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_atender__gineco);
        ...
        txtGinecoFechaMenstruacion = (EditText) findViewById(R.id.txtAtenderGinecoUltimaMenstru);
        showDialogOnEditTextClick();

        //region CREACION SPINNERS

        //Spinner para Ritmo
        spinnerRitmo = (Spinner) findViewById(R.id.spinnerAtenderGinecoRitmo);
        ...
        spinnerEmbarazos = (Spinner) findViewById(R.id.spinnerAtenderGinecoEmbarazos);
        // Create an ArrayAdapter using the string array and a default spinner layout
        ...
        spinnerAbortos = (Spinner) findViewById(R.id.spinnerAtenderGinecoAbortos);
        // Create an ArrayAdapter using the string array and a default spinner layout
        ...
        //Spinner para partos
        spinerPartos = (Spinner) findViewById(R.id.spinnerAtenderGinecoPartos);
        // Create an ArrayAdapter using the string array and a default spinner layout
        ...
        spinnerCesareas = (Spinner) findViewById(R.id.spinnerAtenderGinecoCesareas);
        // Create an ArrayAdapter using the string array and a default spinner layout
